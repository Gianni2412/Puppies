...
{
    public partial class ProformaMigracion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataCategoria", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataContactar", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataDoctores", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataMascota", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataServicios", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataTrabajar", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataProductos_DataCategoria_categoriasid",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataReservas_DataDoctores_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "DataDoctores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataReservas_DataMascota_MascotasId",
                        column: x => x.MascotasId,
                        principalTable: "DataMascota",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataReservas_DataServicios_ServicioId",
                        column: x => x.ServicioId,
                        principalTable: "DataServicios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataReservas_DataUsuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "DataUsuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataProductos_categoriasid",
                table: "DataProductos",
                column: "categoriasid");

            migrationBuilder.CreateIndex(
                name: "IX_DataReservas_DoctorId",
                table: "DataReservas",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DataReservas_MascotasId",
                table: "DataReservas",
                column: "MascotasId");

            migrationBuilder.CreateIndex(
                name: "IX_DataReservas_ServicioId",
                table: "DataReservas",
                column: "ServicioId");

            migrationBuilder.CreateIndex(
                name: "IX_DataReservas_UsuarioId",
                table: "DataReservas",
                column: "UsuarioId");
