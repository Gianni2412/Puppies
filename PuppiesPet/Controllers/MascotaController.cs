...
namespace PuppiesPet.Controllers
{
    public class MascotaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Sexo,Raza,Especie,Edad,Peso,Enfermedades,UsuarioId")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Sexo,Raza,Especie,Edad,Peso,Enfermedades,UsuarioId")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
